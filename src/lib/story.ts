export const CodingStory = [
  ...
  "At the same time, I was competing in the professional circuit for competitive rock climbing. It's a hobby-turned-passion that I began in highschool and haven't given up since. As I got better, I began to believe more and more in my potential as an athlete.",
  "Then, during my second year at Microsoft in 2023, I made the US Team after ten years of climbing. I wondered how good I could get if I focused entirely on my climbing, especially with the 2024 Olympics around the corner.",
  ...
  "I experienced some interesting ups and downs. I fell short of qualifying for the Olympics, but I got to place top 3 at the US National Championships and ranked in the top 50 worldwide. I was also in amazing shape, although I had developed some injuries from overtraining.",
  "My cash runway was also running out. I wanted to regain the balance I had between my software engineering and my climbing, and apply the discipline and problem-solving skills I developed as an athlete.",
